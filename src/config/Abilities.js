...
const abilities = {
  ...
  [CLASSES.DEATHKNIGHT.toUpperCase()]: {
    "BLOOD": [
      new Ability()
      .setCooldown(120)
      .setDuration()
  ...
  [CLASSES.DEMONHUNTER.toUpperCase()]:  {
    "VENGEANCE": [
      new Ability()
      .setCooldown(180)
      .setDuration()
